...
public class PlayGame extends Activity implements OnClickListener {
    ...
    private TextView question, answerTxt, scoreTxt, levelzTxt;
    ...
    private void chooseQuestion(){
        ...
        //vi vill inte ha några negativa värden
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        levelzTxt = (TextView)findViewById(R.id.levelz);
        ...
        myMusic=MediaPlayer.create(PlayGame.this,R.raw.music);
    }
    ...
    public void SetLevel (String level) {
        TextView levelTextView = (TextView)findViewById(R.id.levelz);
        ...
        if(exScore>0){
            ...
            if(scores.length()>0){
                ...
                for(int s=0; s<scoreStrings.size(); s++){
                    if(s>=10) break;//tio ska lagras
                    if(s>0) scoreBuild.append("|");//seperera
                    scoreBuild.append(scoreStrings.get(s).getScoreText());
                }
                    //skriv till prefs
                scoreEdit.putString("highScores", scoreBuild.toString());
                scoreEdit.putInt("scores", getScore());
                //scoreEdit.putInt("highScores", scoreBuild);
                scoreEdit.commit();

                //existerande värden
            }
            else{
                //inga existerande värden
